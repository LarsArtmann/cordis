...
describe("Effects", () => {
  it("dispose by plugin", async () => {
    ...
    expect(fiber.getEffects()).to.deep.equal([{ label: "test", children: [] }]);
  ...
  it("dispose manually", async () => {
    ...
    expect(root.fiber.getEffects()).to.deep.equal([{ label: "anonymous", children: [] }]);
    ...
    expect(root.fiber.getEffects()).to.deep.equal([
      {
        ...
        children: [
          ...
          {
            label: "anonymous",
            children: [{ label: 'ctx.on("custom-event")', children: [] }],
          },
        ],
      },
      { label: 'ctx.on("custom-event")', children: [] },
